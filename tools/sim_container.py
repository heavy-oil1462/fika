#!/usr/bin/env python3
"""fika sim container manager: a simulated espresso machine against YOUR stack.
...
def main() -> int:
    ...
    run_p.add_argument("--root", default="fika", help="MQTT topic root")
    run_p.add_argument("--node", default="sim-fika")
    ...
    for p in sub.choices.values():
        p.add_argument("--name", default="fika-sim",
                       help="container name (default: fika-sim)")
